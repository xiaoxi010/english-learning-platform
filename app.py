...
from digital_talent_web import digital_talent_bp
from lifeway_web import lifeway_bp
from subject_web import subject_bp
from holland_web import holland_bp
from eysenck_web import eysenck_bp
from cattell_web import cattell_bp
from bfi2_web import bfi2_bp
from mbti_web import mbti_bp
from rbti_web import rbti_bp
from feier_web import feier_bp
from constellation_web import constellation_bp
from live_template_web import live_template_bp
from gaokao_apply_web import gaokao_apply_bp
...
app.register_blueprint(digital_talent_bp)
app.register_blueprint(lifeway_bp)
app.register_blueprint(subject_bp)
app.register_blueprint(holland_bp)
app.register_blueprint(eysenck_bp)
app.register_blueprint(cattell_bp)
app.register_blueprint(bfi2_bp)
app.register_blueprint(mbti_bp)  # MBTI 趣味测评 48 题
app.register_blueprint(rbti_bp)
app.register_blueprint(feier_bp)
app.register_blueprint(constellation_bp)
app.register_blueprint(live_template_bp)
app.register_blueprint(gaokao_apply_bp)
